  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.searchParam, searchParam));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(page), const DeepCollectionEquality().hash(searchParam));
...
abstract class GetMoviesStart implements GetMovies {
  const factory GetMoviesStart(int page, {String searchParam}) = _$GetMoviesStart;
...
abstract class GetMoviesSuccessful implements GetMovies {
  const factory GetMoviesSuccessful(List<AppMovie> movies) = _$GetMoviesSuccessful;
